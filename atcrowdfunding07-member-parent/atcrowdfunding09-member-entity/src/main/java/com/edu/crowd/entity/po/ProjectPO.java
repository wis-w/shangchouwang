package com.edu.crowd.entity.po;
...
public class ProjectPO {
	...
	public ProjectPO(Integer id, String projectName, String projectDescription, Integer money, Integer day,
			Integer status, String deploydate, Long supportmoney, Integer supporter, Integer completion,
			Integer memberid, String createdate, Integer follower, String headerPicturePath) {
		super();
		this.id = id;
		this.projectName = projectName;
		this.projectDescription = projectDescription;
