...
<div class="col-sm-3 col-md-2 sidebar">
	<div class="tree">
		<ul style="padding-left: 0px;" class="list-group">
			<li class="list-group-item tree-closed"><a href="admin/to/admin/page.html"><i
			...
			<li class="list-group-item tree-closed"><span><i
				...
				<ul style="margin-top: 10px; display: none;">
					...
					<li style="height: 30px;"><a href="auth/to/authPage.html"><i
							class="glyphicon glyphicon-lock"></i> 权限维护</a></li>
				</ul></li>
			<li class="list-group-item tree-closed"><span><i
